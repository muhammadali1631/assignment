...
const page = () => {
  return (
    <div className='flex flex-col md:flex-row justify-center md:justify-between items-center gap-10 text-xl'>
        <div className='flex flex-col gap-9 items-start md:pl-[12vw] px-4 fade-in'>
        ...
        <Image src={img1} alt='map' className='w-[330px] sm:w-[450px] object-contain flex px-2 fade-in'/>
    </div>
  )
}
